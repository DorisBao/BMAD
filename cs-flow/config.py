...
class_name = "camelyon"  # dataset subdirectory
modelname = "camelyon"  # export evaluations/logs with this name
pre_extracted = True  # were feature preextracted with extract_features?

img_size = (256, 256)  # image size of highest scale, others are //2, //4
