...
parser.add_argument('coords_path', default='coords/train_good.txt', metavar='COORDS_PATH',
                    type=str, help='Path to the input list of coordinates')
parser.add_argument('patch_path', default='data/camelyon16/train/normal', metavar='PATCH_PATH', type=str,
