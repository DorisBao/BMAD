...
class RESC_Dataset(torch.utils.data.Dataset):
    def __init__(self, phase = 'train'):
        root ='/home/jinan/data/RESC/RESC_original'
        transform, gt_transform = get_data_transforms(224, 224)
        if phase == 'train':
...
def load_data(dataset_name='resc', normal_class=0, batch_size='16'):
    ...
    if dataset_name == 'resc':
        ...
        test_data_path = '/home/jinan/data/RESC/RESC_original/test'
